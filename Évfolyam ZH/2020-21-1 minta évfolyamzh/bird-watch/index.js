...
function onGenerate(e) {
  ...
  //b. (1,5 pont) A "Generate table" gombra kattintva a table-container azonosítójú elemben jelenítsd meg JavaScript segítségével a matrix változóban tárolt mátrixot HTML táblázatként (table, tr, td elemeket használva)!
...
delegal(tablazat, 'td', 'click', (esemeny, elem)=>{
  ...
  let s = elem.dataset.sor;
  let o = elem.dataset.cella;
  console.log(s, o);
